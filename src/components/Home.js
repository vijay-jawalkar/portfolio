...
const stickers = [react, javascript, nodejs, tailwind];
...
export function Home() {
  ...
  return (
    <div
      ...
      className="md:h-screen w-full mt-20 md:mt-0"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center md:justify-between gap-4 h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          <p className="pb-6">
            {" "}
            <span className="move  text-2xl">👋</span>{" "}
            <span className="text-zinc-100 text-2xl font-semibold pb-6">
              {" "}
              Hey{" "}
            </span>
          </p>
          ...
          <p className="py-6 font-semibold flex flex-row gap-2">
            ...
            <p
              className={`animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white pr-5 text-lg md:text-2xl text-green-300 font-bold ${
                currentSentenceIndex === 1 ? "hidden" : ""
              }`}
            >
              {sentences[0]}
            </p>
          ...
          <p className="text-cyan-50 py-2 max-w-md">
            Full-Stack Developer with a passion for building dynamic web
            applications using the MERN stack. Bringing a strong foundation and
            a knack for quickly grasping new technologies to every project.
          </p>
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-white w-fit px-6 py-3 my-2 flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-md cursor-pointer"
            >
              Portfolio
        ...
        <div className="relative flex items-center justify-center">
          <img
            src="https://media.licdn.com/dms/image/v2/D4D03AQEnDs-K-SRBIw/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1727287295286?e=1747267200&v=beta&t=mdiV2EgZOIeoHPSdgPW_zf4WYwl2-gX-rgPJn3Ik-_4"
            alt="HeroImage"
            className="object-cover w-[150px] lg:w-[250px] rounded-full mx-auto"
          />
