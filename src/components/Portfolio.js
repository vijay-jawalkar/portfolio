...
import RepairAnna from "../assets/portfolio/repairanna1.png";
...
export function Portfolio() {
  const links = [
    {
      ...
      src: ShopNow,
      skills: "ReactJs, Redux,, Node, Express, MongoDB",
...

    {
      ...
      demo: "https://repair-anna.vercel.app/",
      code: "https://github.com/vijay-jawalkar/repair-anna",
    },
    {
      id: 2,
  ...
  return (
    <div
      ...
      className="w-full pb-28 text-white"
    >
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
          {links.map((link, index) => (
            <div key={index} className="shadow-md shadow-gray-600 rounded-lg">
              <div className="text-sm font-semibold text-center py-2 text-zinc-400">
                {" "}
                {link.title}{" "}
              </div>
              <img
              ...
              <div className="py-2 px-3 text-sm text-center text-zinc-200">
                {" "}
                {link.skills}{" "}
              </div>
            </div>
